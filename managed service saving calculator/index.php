...
.inline-block {display: inline-block;}
 ...
 .zc-result-area>div{background:#fff;padding:3em 1em;display:inline-block;border-radius:10px;color:#002e5b;font-family:'Montserrat', sans-serif;text-align:center;transform-origin:50% 100%;-moz-transform-origin:50% 100%;transform-box:fill-box;transform:scale(0);position:relative;opacity:0;z-index:9;}
 ...
 .calculated-result, .calculated-result-m{font-family:'Montserrat', sans-serif;font-size:30px;color:#39ca86;display:inline-block;line-height:1;}
...
.irs--flat .irs-from, .irs--flat .irs-to, .irs--flat .irs-single {
  ...
  .irs--round .irs-from, .irs--round .irs-to, .irs--round .irs-single {
    ...
    color: #002e5b;
    border-radius: 4px;
    box-shadow: 0 1px 3px rgb(57 202 134/0.3);
  ...
  .irs--round .irs-handle {
    ...
    width: 20px;
    height: 20px;
    background-color:/* #fde428*/rgb(57 202 134);
    border-radius: 24px;
    }
        ...
        <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12 pad-zero">
          <div class="left-out">
            <div class="zc-calc-area">
                         ...
                         <h5 class="blue-text fw-500 mb-25px"> <span class="numberCircle">1</span> Total Number of Members in a Typical Project<b style="color: red;">*</b></h5>
...
<p class="" style="font-size: 13px;"><b style="color: red;">*</b>For more then 6 members, please contact us via the form below</p>
                          ...
                          <h5 class="blue-text fw-500 mb-25px">
                            AS IS  : Average Hourly Rate per Member (USD/Hr) <b style="color: red;">*</b>
                          </h5>
                        ...
                        <div class="div2">
                          ...
                          <div class="mt-4em">
                            ...
                            <h3 class="blue-text center left fw-600">Approximate number of hours spent by each of your developers on following tasks:</h3>
                          </div>
          ...
          <div class="right-out mar-auto">
            <div class="zc-result-area animate">
                                <div class="show-result">
                                  <h3 class="blue-text fw-600">Calculate Your Savings</h3>
...
var getTrackStyle = function (el) {  
  ...
  for (var i = 0; i < prefs.length; i++) {
    style += '.range {background: linear-gradient(to right, #39ca86 0%, #39ca86 ' + val + '%, #fff ' + val + '%, #fff 100%)}';
    style += '.range input::-' + prefs[i] + '{background: linear-gradient(to right, #39ca86 0%, #39ca86 ' + val + '%, #39ca86 ' + val + '%, #39ca86 100%)}';
  }
