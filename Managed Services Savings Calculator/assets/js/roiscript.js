...
//alert(hour_rate);
 	...
 	// 	$('.perhour-amt').html(1 * cVal)
        ...
        $('.calculated-result2, .calculated-result2-m').html(sumval.toLocaleString('en-US'));

        sumval1 = Math.round(((total_price*20)));
        $('.calculated-result1, .calculated-result1-m').html(sumval1.toLocaleString('en-US'));

        sumval2 = Math.round(((sumval1*12)));
        $('.calculated-result3, .calculated-result3-m').html(sumval2.toLocaleString('en-US'));

        sumval2 = Math.round(((sumval1*200/20)));
        $('.calculated-result, .calculated-result-m').html(sumval2.toLocaleString('en-US'));
